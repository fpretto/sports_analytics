...
def draw_boxes(image, frame_n, boxes, labels, obj_thresh, court_pts, dict_players, player=None):
    ...
    for box in boxes:
        ...
        ## Check if it is a person within the court
        for i in range(len(labels)):
            if (box.classes[i] > obj_thresh) & ((Point(player_pos).within(court)) | (Point(torso).within(court))):
                count += 1
                # If first frame, assign first box to player A and second to player B
                if frame_n == 1:
                    if count == 1:
                        label_str += dict_players['player_A']['label']
                        dict_players['player_A']['player_coords'].append(player_pos)
                        dict_players['player_A']['player_torso'].append(image[(torso[1], torso[0])])
                        dict_players['player_A']['tracking_coords'].append(tracking_coords)
                        label = i
                    elif count == 2:
                        label_str += dict_players['player_B']['label']
                        dict_players['player_B']['player_coords'].append(player_pos)
                        dict_players['player_B']['player_torso'].append(image[(torso[1], torso[0])])
                        dict_players['player_B']['tracking_coords'].append(tracking_coords)
                        label = i
                        #print(labels[i] + ': ' + str(box.classes[i]*100) + '%')

                # If second or higher frame, assign to closest to previous point (Euclidean distance)
                else:
                    #dist_player_pos_A = (dict_players['player_A']['player_coords'][-1][0] - player_pos[0])**2 + (dict_players['player_A']['player_coords'][-1][1] - player_pos[1])**2
                    #dist_lower_center_A = (dict_players['player_A']['tracking_coords'][-1][0][0] - lower_center[0])**2 + (dict_players['player_A']['tracking_coords'][-1][0][1] - lower_center[1])**2
                    #dist_mid_left_A = (dict_players['player_A']['tracking_coords'][-1][1][0] - mid_left[0])**2 + (dict_players['player_A']['tracking_coords'][-1][1][1] - mid_left[1])**2
                    #dist_center_A = (dict_players['player_A']['tracking_coords'][-1][2][0] - center[0])**2 + (dict_players['player_A']['tracking_coords'][-1][2][1] - center[1])**2
                    #dist_mid_right_A = (dict_players['player_A']['tracking_coords'][-1][3][0] - mid_right[0])**2 + (dict_players['player_A']['tracking_coords'][-1][3][1] - mid_right[1])**2
                    #dist_torso_A = (dict_players['player_A']['tracking_coords'][-1][4][0] - torso[0])**2 + (dict_players['player_A']['tracking_coords'][-1][4][1] - torso[1])**2
                    #dist_upper_center_A = (dict_players['player_A']['tracking_coords'][-1][5][0] - upper_center[0])**2 + (dict_players['player_A']['tracking_coords'][-1][5][1] - upper_center[1])**2

                    #dist_player_pos_B = (dict_players['player_B']['player_coords'][-1][0] - player_pos[0])**2 + (dict_players['player_B']['player_coords'][-1][1] - player_pos[1])**2
                    #dist_lower_center_B = (dict_players['player_B']['tracking_coords'][-1][0][0] - lower_center[0])**2 + (dict_players['player_B']['tracking_coords'][-1][0][1] - lower_center[1])**2
                    #dist_mid_left_B = (dict_players['player_B']['tracking_coords'][-1][1][0] - mid_left[0])**2 + (dict_players['player_B']['tracking_coords'][-1][1][1] - mid_left[1])**2
                    #dist_center_B = (dict_players['player_B']['tracking_coords'][-1][2][0] - center[0])**2 + (dict_players['player_B']['tracking_coords'][-1][2][1] - center[1])**2
                    #dist_mid_right_B = (dict_players['player_B']['tracking_coords'][-1][3][0] - mid_right[0])**2 + (dict_players['player_B']['tracking_coords'][-1][3][1] - mid_right[1])**2
                    #dist_torso_B = (dict_players['player_B']['tracking_coords'][-1][4][0] - torso[0])**2 + (dict_players['player_B']['tracking_coords'][-1][4][1] - torso[1])**2
                    #dist_upper_center_B = (dict_players['player_B']['tracking_coords'][-1][5][0] - upper_center[0])**2 + (dict_players['player_B']['tracking_coords'][-1][5][1] - upper_center[1])**2
